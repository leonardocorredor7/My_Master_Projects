# FuelWatch Price Analysis

## Personal Context

This project is part of my personal data science portfolio and was originally
developed as coursework during my Master’s program in Data Science.

Beyond the formal assignment requirements, I independently:
- explored fuel price variability over time
- applied descriptive statistics and visual analytics
- investigated patterns and trends in energy price data
- focused on clear communication of analytical insights

This project explores fuel price dynamics using descriptive statistics and
visual analytics, with an emphasis on identifying temporal patterns and
variability in real-world energy market data.

---

## Original Course Context

The project was completed under academic supervision as part of a data
science course. The overall objectives were defined by the course, while the
analysis and implementation reflect my individual work.
