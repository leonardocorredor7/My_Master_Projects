...
In addition to fulfilling the course objectives, I focused on:
- exploratory analysis of large-scale transportation data
- investigation of flight delays and operational patterns
- visualization of complex categorical and temporal variables
- data-driven interpretation of aviation-related metrics

This project applies exploratory data analysis techniques to a large-scale
transportation dataset, focusing on delays, operational behavior, and
patterns in commercial flight data.

---

## Original Course Context

This analysis was conducted as part of a university assignment with defined
assessment criteria. The work presented here was independently developed
