...
Beyond the core course requirements, I independently worked on:
- data cleaning and preprocessing decisions
- exploratory data analysis and visualization choices
- interpretation of temporal and cross-country patterns
- reproducible analysis using Python and Jupyter

This analysis focuses on understanding temporal and cross-country patterns
in COVID-19 indicators using exploratory data analysis and comparative
...
This project was developed as part of a university assignment following
specific academic guidelines and assessment criteria. The original structure
and objectives were defined by the course, while the implementation and
analysis reflect my individual work.
